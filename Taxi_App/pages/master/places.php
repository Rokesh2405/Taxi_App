...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Place(s)"))
            {
                return true;
            }
            else
...
<div class="row">
      ...
      <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Place List</h4>
                                    <ol class="breadcrumb">
                                     ...
                                     <div class="state-information d-none d-sm-block">
                                        <div class="state-graph">
                                           ...
                                           <a href="<?php echo $sitename; ?>master/addplace.htm"><button class="btn btn-success waves-effect waves-light" type="submit">Add New</button></a>
                                        </div>
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <?php
                            $o = '1';
$ord = $db->prepare("SELECT * FROM `place` ORDER BY `id` DESC ");	
$ord->execute();
$ordnum = $ord->rowCount(); 
if($ordnum>0) { 
while ($ford = $ord->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <tr>
                            <td><?php echo $o; ?></td>   
                            <td><?php echo $ford['place']; ?></td>
                            <td><?php if($ford['status']=='1') { echo "Active"; } else { echo "Inactive"; }?></td>
                            ...
                            <tfoot>
                                <tr>
                                    <th colspan="4">&nbsp;</th>
                                    <th align="center"><button type="submit" class="btn-danger" name="delete" id="delete" style="width:100%; height:30px;" value="Delete" onclick="return checkdelete('chk[]');"> DELETE </button></th>
                                </tr>
                            </tfoot>
                                    </table>
</form>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editplace.htm';
    }     
</script>
<?php
