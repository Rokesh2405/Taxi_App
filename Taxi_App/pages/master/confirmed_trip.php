...
<div class="row">
      ...
      <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Confirmed Trips List</h4>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);"><?php echo $_SESSION['sitename']; ?></a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Master </a></li>
                                        <li class="breadcrumb-item active">>Confirmed Trips</li>
                                    </ol>
...
<script type="text/javascript">
    $('#datatable').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=conftriptable"
    });
</script>