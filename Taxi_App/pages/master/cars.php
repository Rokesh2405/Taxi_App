...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Car(s)"))
            {
                return true;
            }
            else
                                    ...
                                    <ol class="breadcrumb">
                                     ...
                                     <div class="state-information d-none d-sm-block">
                                        <div class="state-graph">
                                           ...
                                           <a href="<?php echo $sitename; ?>master/addcar.htm"><button class="btn btn-success waves-effect waves-light" type="submit">Add New</button></a>
                                        </div>
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <?php
                            $o = '1';
$ord = $db->prepare("SELECT * FROM `cars` ORDER BY `id` DESC ");	
$ord->execute();
$ordnum = $ord->rowCount(); 
if($ordnum>0) { 
while ($ford = $ord->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <tr>
                            <td><?php echo $o; ?></td>   
                            <td><?php echo gettypes('name',$ford['type']); ?></td>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editcar.htm';
    }     
</script>
<?php
