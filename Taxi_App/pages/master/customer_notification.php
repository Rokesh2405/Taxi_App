...
$users = pFETCH("SELECT * FROM `register` WHERE `device_key`!=?", '');
...
$query = "INSERT INTO `admin_notification` SET
                    `type`='customer',`title`='".$title."',`message`='".$message."' ";
...
<div class="row">
      ...
      <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Customer Notification List</h4>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);"><?php echo $_SESSION['sitename']; ?></a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Master </a></li>
                                        <li class="breadcrumb-item active">Customer Notification List</li>
                                    </ol>
...
<form name="listform" id="listform" method="post">
    <div class="row">
    <div class="col-md-12"><h5>Send Notification to Customer</h5></div>    
    </div>
   <hr>
    <div class="row">
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <?php
                                $o = '1';
                                  $drivcharge = DB("SELECT * FROM `admin_notification` WHERE `type`='customer' ORDER BY `id` DESC ");
