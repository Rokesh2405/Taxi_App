...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Price(s)"))
            {
                return true;
            }
            else
...
<div class="row">
      ...
      <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <!--       <a href="<?php echo $sitename; ?>master/add.htm"><button class="btn btn-success waves-effect waves-light" type="submit">Add New</button></a>-->
                                    <!--    </div>-->
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editprice_list.htm';
    }     
</script>
<?php
...
<script type="text/javascript">
    $('#datatable').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=pricelisttable"
    });
</script>