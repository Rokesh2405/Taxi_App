...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Record(s)"))
            {
                return true;
            }
            else
                                ...
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb">
                                     ...
                                     <div class="state-information d-none d-sm-block">
                                        ...
                                        <!--   <a href="<?php echo $sitename; ?>master/addtype.htm"><button class="btn btn-success waves-effect waves-light" type="submit">Add New</button></a>-->
                                        <!--</div>-->
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/edittype.htm';
    }     
</script>
<?php
...
<script type="text/javascript">
    $('#datatable').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=typetable"
    });
</script>