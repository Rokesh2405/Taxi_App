                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="page-title-box">
                                    <h4 class="page-title">Onprocess Trips List</h4>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);"><?php echo $_SESSION['sitename']; ?></a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Master </a></li>
                                        <li class="breadcrumb-item active">Onprocess Trips List</li>
                                    </ol>
...
<?php
$o = '1';
$ord = $db->prepare("SELECT * FROM `booking` WHERE `completed_status`='1' AND `total_amount_to_pay` IS NULL ORDER BY `trip_date` ASC, `trip_time` ");	
$ord->execute();
$ordnum = $ord->rowCount(); 
if($ordnum>0) { 
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="line-height: 5px;">
                                                  ...
                                                  <?php echo date('d-M-Y',strtotime($ford['trip_date'])); ?>   
                                                    ...
                                                    <div class="col-md-3" align="left" style="line-height:20px;">
                                                  <?php echo trim($ford['customer_booking_amount']); ?>   
                                                    </div> 
                                                   </div>
                                                   <br>
                                                 ...
                                                 <div class="row">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-3"  align="left">
                                                   <?php if($ford['additional_distance']!='') { echo $ford['additional_distance']; } else { echo ""; } ?>
                                                    </div> 
                                                     <div class="col-md-3" align="left">
                                                    <label>Minimum Kilometer</label>    
                                                    </div> 
                                                    <div class="col-md-3"  align="left">
                                                   <?php if($ford['per_Day_target']!='') { echo $ford['per_Day_target']; } else { echo ""; } ?>
                                                    </div> 
                                                   </div>
                                                   <br>
                                                   <div class="row">
                                                   ...
                                                   <?php if($ford['distance']!='') { echo $ford['distance']; } else { echo ""; } ?>
                                                    ...
                                                    <div class="col-md-3"  align="left">
                                                   <?php if($ford['bataFee']!='') { echo $ford['bataFee']; } ?>
                                                    </div> 
                                                   </div>
                                                   <br>
                                                   <div class="row">
