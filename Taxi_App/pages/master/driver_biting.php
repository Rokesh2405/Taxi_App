...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr align="center">
                                    ...
                                    <th style="width:20%;">Bitting Amount</th>
                                    <th style="width:20%;">Total Trips</th>
                            ...
                            <tbody>
                             <?php
                               $o = '1';
                               $ord = pFETCH("SELECT * FROM `driver_bitting` WHERE `id`!=?", 0);
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/viewriding.htm';
    }     
</script>
<?php
...
<script type="text/javascript">
    $('#datatable').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=ridingtable"
    });
</script>