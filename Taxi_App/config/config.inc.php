...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=taxiapp;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/taxi_app/';
    $fsitename = 'http://localhost/ttbilling/taxi_app/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOTS', $fsitename);
    define('WEB_ROOT', $sitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/uploadapp/";
} else {
    $db = new PDO('mysql:host=localhost;dbname=taxi_app;charset=utf8mb4', 'taxi_app', 'taxiapp');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "taxi_app", "taxiapp", "taxi_app");
    $sitename = "https://ttbilling.in/taxi_app/";
    $site = 'https://ttbilling.in/taxi_app/';
    $fsitename = 'https://ttbilling.in/taxi_app/';
