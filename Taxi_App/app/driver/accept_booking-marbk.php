...
$query = "INSERT INTO `notification` SET
                    `booking_id`='".$data->notification_id."',`from`='".$data->driver_id."',`to`='admin',`title`='".$title1."',`message`='".$message."',`type`='Driver-Admin' ";
...
$uquery = "UPDATE `notification` SET
                    accept_status='1',`driver_name`='".$data->driver_name."',`driver_mobileno`='".$data->driver_mobileno."',`driver_carno`='".$data->driver_carno."',`cartype`='".$data->cartype."',`confirm_status`='1' WHERE `booking_id`='".$data->notification_id."' AND `confirm_status`='1' AND `driver_charge`!=''";
...
$ustmt->execute();
	...
	$ubookquery = "UPDATE `booking` SET
                    request_status='1',`completed_status`='0' WHERE `id`='".$data->notification_id."'";
